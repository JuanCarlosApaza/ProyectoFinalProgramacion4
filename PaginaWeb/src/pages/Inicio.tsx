    ...
    <>
      <div className="bg-gradient-to-br from-gray-900 via-black to-gray-800 w-full min-h-screen">
        ...
        <div className="min-h-screen flex flex-col md:flex-row bg-transparent text-white overflow-x-hidden">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-center p-4 sm:p-6 md:p-14 lg:p-20 text-center md:text-left">
            <div className="max-w-2xl w-full">
              <div className="flex items-center justify-center md:justify-start mb-6">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-none">
                  WIKIGEEK
                </h1>
                <img
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 lg:p-10 mt-6">
            {/* Contenedor de imágenes */}
            <div className="relative w-full max-w-md md:max-w-full h-auto md:min-h-[30rem] flex items-center justify-center gap-4 md:gap-0 mb-4">
              {/* Vista en móvil */}
              <div className="flex flex-col md:hidden gap-3 sm:gap-4 w-full">
                <Link to="/Games" className="w-full">
                  <img
                    src="/Inicio/img3.jpg"
                    alt="imagen3"
                    className="w-full h-auto max-h-96 sm:max-h-80 object-cover rounded-lg shadow-xl"
                  />
                </Link>
                <Link to="/Peliculas" className="w-full">
                  <img
                    src="/Inicio/img1.jpg"
                    alt="imagen1"
                    className="w-full h-auto max-h-96 sm:max-h-80 object-cover rounded-lg shadow-xl"
              ...
              <div className="hidden md:flex relative w-full h-full min-h-[36rem] justify-center items-center">
                <Link
                  to="/Games"
                  className="absolute left-0 top-0 w-[45%] max-w-[350px] z-20 hover:z-50 transition-all duration-300"
                >
                  <img
                    src="/Inicio/img3.jpg"
                    alt="imagen3"
                    className="w-full h-auto max-h-[35rem] object-cover rounded-lg shadow-xl 
                hover:scale-110 hover:-translate-y-4 hover:shadow-2xl"
                  />
                </Link>
                <Link
                  to="/Peliculas"
                  className="absolute left-1/2 top-8 transform -translate-x-1/2 w-[50%] max-w-[360px] z-30 hover:z-50 transition-all duration-300"
                >
                  <img
                    src="/Inicio/img1.jpg"
                    alt="imagen1"
                    className="w-full h-auto max-h-[38rem] object-cover rounded-lg shadow-xl 
                hover:scale-110 hover:-translate-y-4 hover:shadow-2xl"
                  />
                </Link>
                <Link
                  to="/Books"
                  className="absolute right-0 top-16 w-[45%] max-w-[350px] z-10 hover:z-50 transition-all duration-300"
                >
                  <img
                    src="/Inicio/img2.jpg"
                    alt="imagen2"
                    className="w-full h-auto max-h-[34rem] object-cover rounded-lg shadow-xl 
                hover:scale-110 hover:-translate-y-4 hover:shadow-2xl"
                  />
                </Link>
              </div>
        ...
        <div
          ...
          className={`w-full max-w-4xl mx-auto p-6 text-white text-justify md:text-left transition-opacity duration-1000 ease-in-out ${
            estaVisible.section2 ? "opacity-100" : "opacity-0"
          }`}
        >
          <h1 className="text-white text-5xl mb-10">
            Con tres bibliotecas cargadas del <br /> contenido de su
            preferencias
          </h1>
        ...
        >
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <img
              ...
              className="max-w-[80%] sm:max-w-[80%] h-auto rounded-lg"
            />
          </div>
        </div>
        <div className="border-t border-[0.8px] border-gray-300 mb-4 w-[90%] mx-auto"></div>
        ...
        >
          ...
          <div className="w-full md:w-1/2 flex justify-center order-1 md:order-1">
            <img
              src="/Inicio/img8.png"
              alt="Ilustración de inteligencia artificial"
              className="max-w-[70%] sm:max-w-[80%] h-auto rounded-lg"
            />
          </div>

          {/* Columna derecha*/}
          <div className="w-full md:w-1/2 space-y-2 text-white px-4 sm:px-8 md:px-16 xl:px-32 text-center md:text-left order-2 md:order-2">
        ...
        >
          ...
          <div className="w-full md:w-1/2 flex justify-center order-2 md:order-1">
            <img
              src="/Inicio/img12.png"
              alt="Ilustración de registro"
              className="max-w-[70%] sm:max-w-[70%] h-auto rounded-lg"
            />
          </div>

          {/* Columna derecha */}
          <div className="w-full md:w-1/2 space-y-2 text-white px-4 sm:px-8 md:px-16 xl:px-32 text-center md:text-left order-1 md:order-2">
            <h1 className="text-2xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl leading-tight sm:leading-none mb-2 font-exo md:text-left">
